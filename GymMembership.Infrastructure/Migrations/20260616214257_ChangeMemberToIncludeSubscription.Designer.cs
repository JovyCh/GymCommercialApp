...
namespace GymMembership.Infrastructure.Migrations
{
    ...
    [Migration("20260616214257_ChangeMemberToIncludeSubscription")]
    partial class ChangeMemberToIncludeSubscription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GymMembership.Domain.Subscription", b =>
                {
                    b.HasOne("GymMembership.Domain.Member", "Member")
                        ...
                        .HasForeignKey("GymMembership.Domain.Subscription", "MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
